class Api::BooksController < ApplicationController
  ...
  def create
    ...
    if @book.valid?
      ...
      render json: { error: 'Failed to create the book', details: @book.errors.full_messages },
  ...
  def update
    ...
    if @book.update(book_params)
      ...
      render json: { error: 'Failed to update the book', details: @book.errors.full_messages },
             status: :unprocessable_entity
    end
  end
